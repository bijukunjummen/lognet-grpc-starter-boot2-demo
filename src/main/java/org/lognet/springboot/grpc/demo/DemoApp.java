...
public class DemoApp {
	...
	@Bean
	public DelegatingTracingServerInterceptor delegatingTracingServerInterceptor() {
        return new DelegatingTracingServerInterceptor(GrpcTracing.create(Tracing.newBuilder().build()).newServerInterceptor());
    }
